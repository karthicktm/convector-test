...
npm run cc:start -- paymentcompliance
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke paymentcompliance paymentcompliance_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- paymentcompliance org1
# Install to your blockchain - From the root of your project
hurl install paymentcompliance node -P ./chaincode-paymentcompliance
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install paymentcompliance node -P ./chaincode-paymentcompliance --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade paymentcompliance node 1.2 -P ./chaincode-paymentcompliance
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- paymentcompliance 1.2
```
