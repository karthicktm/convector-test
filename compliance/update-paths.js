...
const configFilePath = path.join(__dirname, './org1.paymentcompliance.config.json');
const configFilePath2 = path.join(__dirname, './org2.paymentcompliance.config.json');
